...
class ProbationContractExpired extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
                    ->subject('Cảnh báo HĐTV số ' . $employee_contract->code . ' ' . $employee_contract->employee->name . ' sắp hết hạn vào ngày ' . date('d/m/Y', strtotime($employee_contract->end_date)))
                    ...
                    ->line('Xin mời bạn làm các thủ tục tiếp theo.')
                    ->line('Xin cảm ơn!');
    }
