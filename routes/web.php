...
Route::name('admin.')->prefix('admin')->group(function() {
    Route::group(['middleware'=>'auth:admin'], function() {
        ...
        Route::get('reports/situationData', [AdminReportController::class, 'situationData'])->name('reports.situationData');
        ...
        Route::get('reports/candidate_dec_bhxh_data', [AdminReportController::class, 'candidateDecBhxhData'])->name('reports.candidateDecBhxhData');
        ...
        Route::get('reports/document', [AdminReportController::class, 'document'])->name('reports.document');
        Route::get('reports/documentData', [AdminReportController::class, 'documentData'])->name('reports.documentData');
        ...
        Route::get('hr/contracts/terminate_form/{id}', [AdminEmployeeContractController::class, 'terminateForm'])->name('hr.contracts.terminate_form');
        ...
        Route::get('hr/salaries/off/{id}', [AdminEmployeeSalaryController::class, 'getOff'])->name('hr.salaries.getOff');
