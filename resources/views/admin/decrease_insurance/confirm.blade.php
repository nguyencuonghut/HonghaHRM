    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                    <form class="form-horizontal" method="post" action="{{ route('admin.decrease_insurances.confirm', $decrease_insurance->id) }}" name="confirm" id="confirm" novalidate="novalidate">
                        {{ csrf_field() }}
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                  ...
                                  <div class="input-group date" id="confirmed_month" data-target-input="nearest">
                                      <input type="text" name="confirmed_month" class="form-control datetimepicker-input" value="{{date('m/Y', strtotime($decrease_insurance->employee_work->end_date))}}" data-target="#confirmed_month"/>
