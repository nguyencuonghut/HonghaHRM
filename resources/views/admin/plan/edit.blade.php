        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('admin.plans.index') }}">Tất cả kế hoạch thử việc</a></li>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form class="form-horizontal" method="post" action="{{ route('admin.plans.update', $plan->id) }}" name="edit_plan" id="edit_plan" novalidate="novalidate">
                            {{ csrf_field() }}
                            @method('PATCH')
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="form-control" name="work_title" id="work_title" required="" value="{{$plan->work_title}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="input-group date" id="work_deadline" data-target-input="nearest">
                                            <input type="text" name="work_deadline" class="form-control datetimepicker-input" data-target="#work_deadline" value="{{date('d/m/Y', strtotime($plan->work_deadline))}}"/>
                                    ...
                                    <div class="col-6">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="form-control" name="instructor" id="instructor" required="" value="{{$plan->instructor}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
