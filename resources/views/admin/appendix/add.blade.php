...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Thêm phụ lục cho HĐ số {{$employee_contract->code}}</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                    <form class="form-horizontal" method="post" action="{{ route('admin.hr.appendixs.add', $employee_contract->id) }}" enctype="multipart/form-data" name="add_appendix" id="add_appendix" novalidate="novalidate">
                        {{ csrf_field() }}
                        <!-- /.card-header -->
                        <div class="card-body">
                            <input type="hidden" name="employee_id" id="employee_id" value="{{$employee_contract->employee_id}}">
                            <input type="hidden" name="employee_contract_id" id="employee_contract_id" value="{{$employee_contract->id}}">
                            <div class="row">
                                <div class="col-6">
