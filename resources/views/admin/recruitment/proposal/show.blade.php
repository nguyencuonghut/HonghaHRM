                                  ...
                                  @if ($first_interview_invitation)
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            {{$candidate->name}} @if ($first_interview_result)<span class="badge badge-success">{{$first_interview_result}}</span> , bởi <span class="badge badge-success">{{$first_interview_result->interviewer->name}}</span>@endif
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <div class="table-responsive">
                                                <table id="first-interview-table" class="table table-bordered table-striped">
                                                <thead>
                                                    <tr>
