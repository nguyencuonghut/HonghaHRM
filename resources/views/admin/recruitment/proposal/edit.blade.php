    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                    <form class="form-horizontal" method="post" action="{{ route('admin.recruitment.proposals.update', $proposal->id) }}" name="add_proposal" id="add_proposal" novalidate="novalidate">
                        @method('PATCH')
                        {{ csrf_field() }}
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="row">
                                        ...
                                        <div class="controls">
                                            <select name="company_job_id" id="company_job_id" data-placeholder="Chọn vị trí" class="form-control select2" style="width: 100%;">
                                                ...
                                                @foreach($company_jobs as $company_job)
                                                    <option @if ($company_job->id == $proposal->company_job_id) selected @endif value="{{$company_job->id}}">{{$company_job->name}} - {{$company_job->division_id ? $company_job->division->name : ''}} {{$company_job->department_id ? $company_job->department->name : ''}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="number" class="form-control" name="quantity" id="quantity" required="" value="{{$proposal->quantity}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="number" class="form-control" name="salary" id="salary" required="" value="{{$proposal->salary}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group date" id="work_time" data-target-input="nearest">
                                        <input type="text" name="work_time" class="form-control datetimepicker-input" value="{{date('d/m/Y', strtotime($proposal->work_time))}}" data-target="#work_time"/>
