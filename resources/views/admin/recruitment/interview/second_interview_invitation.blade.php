    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form class="form-horizontal" method="post" action="{{ route('admin.recruitment.second_interview_invitation.store', $proposal_candidate->id) }}" name="create_first_interview_invitation" id="create_first_interview_invitation" novalidate="novalidate">
                            {{ csrf_field() }}
                            <div class="card-body">
