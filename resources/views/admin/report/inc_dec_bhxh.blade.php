...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Tất cả tăng - giảm BHXH</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Trang chủ</a></li>
            <li class="breadcrumb-item active">Tăng Giảm BHXH</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="card card-secondary">
                  ...
                  <!-- /.card-header -->
                  <div class="card-body">
                    <a href="{{route('admin.reports.exportIncBhxh')}}" class="btn btn-sm btn-primary"><i class="fas fa-cloud-download-alt"></i></a>
...
<script>
    $(function () {
      ...
      $('#inc-employees-table').DataTable({
        ...
        //dom: 'Blfrtip',
        ajax: {
          url: "{{ route('admin.reports.incBhxhData') }}",
        },
        columns: [
       ...
       $('#dec-employees-table').DataTable({
        ...
        columns: [
            ...
            {data: 'decrease_confirmed_month', name: 'decrease_confirmed_month'},
            {data: 'insurance_salary', name: 'insurance_salary'},
